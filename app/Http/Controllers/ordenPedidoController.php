...
class ordenPedidoController extends Controller
{
    ...
    public function ordenes()
    {
        $ordenes = DB::table('orden_pedido')->join('cliente', 'orden_pedido.cliente_id', '=', 'cliente.id')
            ...
            ->select([
                'orden_pedido.id', 'cliente.nombre_cliente', 'cliente_sucursales.nombre_sucursal', 
                'orden_pedido.fecha', 'orden_pedido.fecha_entrega', 'orden_pedido.notas', 
                'orden_pedido.generado_internamente', 'orden_pedido.detallada', 'users.name','orden_pedido.no_orden_pedido'
            ]);
    ...
    public function imprimir($id)
    {
        ...
        'total', 'cantidad', 'total_simple'))->setPaper('a4');
