...
class SKUController extends Controller
{
    ...
    public function skus()
    {
        ...
        $skus = DB::table('sku')->rightJoin('corte', 'sku.producto_id', '=', 'corte.producto_id')->rightJoin('producto', 'sku.producto_id', '=', 'producto.id')
            ->select([
        ...
        ///////////////////////////////////////////////
            ...
            //    $producto = $sku->producto_id;
                ...
                //    return '<a href="print_label/' . $sku->id . '" target="_blank" class="btn btn-primary btn-sm ml-1"> <i class="fas fa-print"></i></a>';
                    return '<button id="print_label" onclick="mostrar(' . $sku->id . ')" class="btn btn-primary btn-sm ml-1" > <i class="fas fa-external-link"></i></button>';
                } else {
                    return "";
                }
            }) 
