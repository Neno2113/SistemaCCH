...
/*
    ...
    public function imprimirlabel($id)
    {
        ...
        $data = ['referencia' => $skus->referencia_producto, 'sku' => $skus->sku, 'talla' => $talla, 'entalle_bragueta' => $entalle_bragueta, 'entalle_piernas' => $entalle_piernas, 'fecha_corte' => $corte->fecha_corte];
