                ...
                <form action="" id="formulario" class="form-group carta panel-body" enctype="multipart/form-data">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="atributo_no_1" id="atributo_no_1" class="form-control text-center "
                                readonly>
                        </div>
                        <div class="col-md-4">
                            <label for="">Atributo No.2</label>
                            <input type="text" name="atributo_no_2" id="atributo_no_2" class="form-control text-center "
                                readonly>
                        </div>
                        <div class="col-md-4">
                            <label for="">Atributo No.3</label>
                            <input type="text" name="atributo_no_3" id="atributo_no_3" class="form-control text-center "
                                readonly>
                        </div>
                    </div>
                    <br>
