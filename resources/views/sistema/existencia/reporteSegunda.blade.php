...
<div class="card" id="listadoUsers">
    <div class="card-header bg-dark">
        <h4 class="text-center text-white">Reporte Segundas</h4>
    </div>
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-2 mt-4 pt-2">
                <button type="button" id="btn-generarSegunda" class="btn btn-orange"> <i class="fas fa-calculator"></i> Generar</a>
    ...
    <div class="card-footer text-muted " style="background: transparent;">
        <a id="btn-printSegunda" class="btn btn-secondary float-right"> <i class="fas fa-print"></i> Imprimir</a>
    </div>
