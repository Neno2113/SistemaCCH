	...
	<main>
		<div id="details" class="clearfix">
			...
			<table class="tabla-factura">
				<thead>
					<tr>
						<th class="factura">PERDIDA</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td class="num_factura">{{$perdida->no_perdida}}</td>
					</tr>
					<tr>
						<td class="fecha">Fecha:{{date("d/m/20y", strtotime($perdida->fecha))}}</td>
					</tr>
					<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" class="tabla-principal">
			<thead>
				<tr>
					...
					<th class="desc">TIPO PERDIDA</th>
					<th class="unit">FASE</th>
					<th class="total">MOTIVO</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td class="desc">
						<li>{{$perdida->producto->referencia_producto}}</li>
					</td>
					<td class="no">
						<li>{{date("d/m/20y", strtotime($perdida->fecha))}}</li>
					</td>
					<td class="unit">
						<li>{{$perdida->tipo_perdida}}</li>
					</td>
					<td class="unit">
						<li>{{$perdida->fase}}</li>
					</td>
					<td class="total">
						<li>{{$perdida->motivo}}</li>
					</td>
				</tr>
			</tbody>
		...
		<div id="thanks">DOCUMENTO DE PERDIDAS</div>
		<div id="notices">
			<div>NOTAS:</div>
			<p class="notice">Prueba de impresion de documento de perdida.</p>
