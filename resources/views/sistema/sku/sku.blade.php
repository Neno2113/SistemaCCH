    ...
    <div class="col-12">
        <div class="card  mb-3" id="tallasSku">
            ...
            <div class="card-footer  text-muted">
                ...
                <div class="col-md-6 mt-3" style="margin-left: 10pc;"> Leyenda: <!-- <span style="background-color: #d4f0ff; padding: 5px;">SKU General</span> --><span style="background-color: #c7d8e9; padding: 5px;">SKU Especiales</span></div>
            </div>
