...
<body style="margin: 0; background-color: #ffffff; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	...
	?>
		...
		<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding-top: 5px" width="100%">
		<tbody>
		<tr>
		<td>
		...
		<tbody>
		<tr>
		<td  style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="55%">
		...
		<td class="column column-2" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="40%">
		<table border="0" cellpadding="0" cellspacing="0" class="paragraph_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
		<tr>
		...
		<?php 
			if ($tipo_barcode == "code128") {
				?>
				<div align="center" style="font-family:Cabin, Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;"><div class="our-class" style="font-size: 11px;"><!-- Reemplazar div con precio --><div style="/* background-color: #000; */ height: 16px;"></div> <!-- Fin reemplazar div con precio --> </div></div>
				<?php
			} else {
				?>
				<div align="center" style="font-family:Cabin, Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;"><div class="our-class" style="font-size: 11px;"><!-- Reemplazar div con precio --><div style="/* background-color: #000; */ height: 23px;"></div> <!-- Fin reemplazar div con precio --> </div></div>
				<?php
			}
			?>
		</td>
