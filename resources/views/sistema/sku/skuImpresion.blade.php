...
<body style="margin: 0; background-color: #ffffff; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	...
	?>
		...
		<tr>
		<td class="pad">
		<div align="center" style="font-family:Cabin, Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;"><div class="our-class" style="font-size: 11px;"><!-- Reemplazar div con precio --><div style="/* background-color: #000; */ height: 30px;"></div> <!-- Fin reemplazar div con precio --> </div></div>
		</td>
		</tr>
		</table>
		</td>
