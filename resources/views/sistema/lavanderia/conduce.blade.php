...
<head>
    <meta charset="utf-8">
    <title>Conduce Lavanderia</title>
    <style>
        @font-face {
        ...
        <table class="tabla-factura">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="num_factura">{{$lavanderia->fecha_envio}}</td>
                </tr>
                <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0" class="tabla-principal">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="desc-des">
                        @if (!empty($lavanderia->producto->referencia_producto_2))
                        <li>{{$lavanderia->producto->descripcion}} -
                            {{$lavanderia->producto->descripcion_2}}</li>
                        @else
                        <li>{{$lavanderia->producto->descripcion}}</li>
                        @endif
                    </td>
                    <td class="total">
                        <li>{{$lavanderia->total_enviado}}</li>
