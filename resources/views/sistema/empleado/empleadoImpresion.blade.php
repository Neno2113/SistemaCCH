			...
			<table border="0" cellspacing="0" cellpadding="0" class="tabla-cliente">
				...
				<tbody>
					...
					<tr>
						...
						<td class="direccion">{{$empleado->calle}}, {{$empleado->sector}}
							{{$empleado->provincia}}, {{$empleado->sitios_cercanos}}<</td> </tr> <tr>
						<th>Cedula</th>
						<td>{{$empleado->cedula}}</td>
					</tr>
					<tr>
						<th>Telefonos</th>
						<td>{{$empleado->telefono_1 - $empleado->telefono_2}}</td>
					</tr>
					<tr>
						<th>Correo</th>
...
<!--
			<table class="tabla-factura">
				...
				<tbody>
					<tr>
						<td class="num_factura">{{$orden->no_orden_pedido}}</td>
					</tr>
					<tr>
